...
public class ArrayList_Reviews {

	public static void main(String[] args) {

		/*
		 * Array: size is fixed. supports primitives, wrapper class and objects
		 * (immutable)
		 */
		...
		/*
		 * ArrayList: does not support primitives, size is not fixed. (mutable version
		 * of array).
		 */
