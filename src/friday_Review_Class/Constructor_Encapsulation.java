...
class BB{
	...
	BB(){
	//	  this(9.8);  // reason: line 10   rule #7
	}
	...
	public void method1() {
	// 	this();  //  methods orblocks cannot call constructor.
...
// Methods: 	
//	AM         specifier     Return Type      method name
	...
	// Constructor:   
			//      Required		
	public         Constructor_Encapsulation() {
//	AM	              methodname ( has to be same with class name)
	}
}
	
	
	
	// constructor's method name has to be same with class anme
