...
public class Notes_About_Constructor {
/*
...
// static import 
  ...
  ANY OCA QUESTION YOU GOT ABOUT INSTANCE BLOCK 
    ...
    *  Instance method should be used if you want to read or manipulate properties ir state of object
      
    * Static method--most of the time its used for utility method
      if your method is not doing any action to read or manipulate properties  or state of the object
