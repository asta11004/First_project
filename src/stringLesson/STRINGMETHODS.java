...
public class STRINGMETHODS {
	...
	/*	
		.charAt(); ==> RETURNS char
				.length(); ==> RETURNS int
				.contains(substring); ==> RETURNS boolean
				.startsWith(substring); ==> RETURNS boolean
				.endsWith(substring); ==> RETURNS boolean
				.indexOf(substring); ==> RETURNS int
				.lastIndexOf(substring) ==> RETURNS int (index of first letter of the substring)
				.substring(beginindex,endindex)  ==> RETURNS String
				.isEmpty(boolean) ==> RETURNS boolean
