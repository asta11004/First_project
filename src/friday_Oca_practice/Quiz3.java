...
System.out.println(Arrays.toString(numbers2));
		...
		*/
				 ...
				 String str="Hello World";
				 		str = str.trim() ;
		         // trim() removes unused spaces : spaces that not seprating letters  (white space)
		     int z=str.indexOf(" ");
...
//    }
       ...
       System.out.println(res);    // res: walter
		...
		commend line:  Javac  classname.java
					   java  classname  args[0] arr[1] .....    (arguments)
	
	
		Which command-line arguments should you pass to the program to obtain 		
		the following output? number is 2	
	
		A. java Spartans 0 1 2 3      args=  [ 0, 1, 2, 3 ]      args[3]= 3
		B. java Spartans 1 2 2 3      args= [ 1, 2, 2, 3 ]     args[3]= 3
		C. java Spartans 1 2 2 3 4    args= [ 1, 2, 2, 3, 4]   args[3]= 3
		D. java Spartans 1 3 2 2       args= [1, 3, 2, 2 ]      args[3]= 2      ( Correct)
